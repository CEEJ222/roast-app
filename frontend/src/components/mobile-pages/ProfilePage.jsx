...
import ThemeToggle from '../user_profile/ThemeToggle';
...
const ProfilePage = ({
  ...
  const [activeTab, setActiveTab] = useState('account'); // 'account' or 'machines'
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg-primary">
      ...
      {!isMobile && (
        <div className="bg-gradient-to-r from-indigo-700 via-purple-600 to-purple-700 dark:bg-accent-gradient-vibrant px-4 py-6 text-white">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold mb-2">Profile Settings</h1>
                <p className="opacity-90 text-sm sm:text-base">Manage your profile and machines</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Content */}
      <div className={`px-4 ${isMobile ? 'py-4 pb-24' : 'py-6'}`}>
        <div className="max-w-7xl mx-auto">
          {/* Status Messages */}
          {error && (
          ...
          {isMobile && (
            <div className="flex bg-gray-100 dark:bg-dark-bg-tertiary rounded-lg p-1 mb-6">
              <button
                onClick={() => setActiveTab('account')}
                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${
                  activeTab === 'account'
                    ? 'bg-white dark:bg-dark-bg-secondary text-indigo-600 dark:text-indigo-400 shadow-sm'
              ...
              <div className="space-y-6">
                <div>
                  <h2 className="text-xl font-bold text-gray-800 dark:text-dark-text-primary mb-4">
                    {isMobile ? 'Account' : 'Profile Information'}
                  </h2>
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-indigo-700 hover:to-purple-700 font-medium transition disabled:opacity-50 shadow-lg"
                  >
                    Update Profile
                  </button>
                </div>
                      ...
                      {editingMachine?.id === machine.id ? (
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            <h3 className="font-semibold text-gray-800 dark:text-dark-text-primary">{machine.name}</h3>
